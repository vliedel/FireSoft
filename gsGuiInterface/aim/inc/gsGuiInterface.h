...
public:
  ...
  void Init(std::string module_id) {
    ...
    
    {
      ...
      portName << "/gsguiinterface" << module_id << "/command";
      portCommand->open(portName.str().c_str());
    }
    {
      std::stringstream portName; portName.str(); portName.clear();
      portName << "/gsguiinterface" << module_id << "/status";
      portStatus->open(portName.str().c_str());
    }
    {
      std::stringstream portName; portName.str(); portName.clear();
      portName << "/gsguiinterface" << module_id << "/toradio";
      portToRadio->open(portName.str().c_str());
    }
    {
      std::stringstream portName; portName.str(); portName.clear();
      portName << "/gsguiinterface" << module_id << "/fromradio";
